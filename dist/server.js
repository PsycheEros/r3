...
/******/ 			var chunk = require("./" + ({"vendors~main~server":"vendors~main~server","main~server":"main~server"}[chunkId]||chunkId) + ".js");
...
_cluster.default.on('disconnect', () => {
  if (production) {
    if (!stopping) {
...
if (_cluster.default.isMaster) {
  ...
  Promise.all(/*! import() | main~server */[__webpack_require__.e("vendors~main~server"), __webpack_require__.e("main~server")]).then(__webpack_require__.t.bind(null, /*! ./main */ "./src/server/main.ts", 7));
}
