    ...
    render() {
        ...
        for (const _ref of board) {
            ...
            if (color !== null) {
                ...
                radialGradient = c2d.createRadialGradient(center.x, center.y, 0, isDark ? lightCenter.x : shadowCenter.x, isDark ? lightCenter.y : shadowCenter.y, radius), rgb = isDark ? '255,255,255' : '0,0,0';
        ...
        Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["combineLatest"])(gameService.getGames(), currentRoom, (games, room) => room ? games.filter(game => game.gameId === room.gameId)[0] || null : null).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["takeUntil"])(destroyed), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["observeOn"])(scheduler)).subscribe(game => {
            ...
            if (game) {
                ...
                if (gameState.turn == null)
                    ...
                    this.turn = data_colors_yaml__WEBPACK_IMPORTED_MODULE_4__["colors"][game.colors[gameState.turn]].displayName;
            }
            else {
                this.gameState = null;
                this.board = null;
...
/* harmony import */ var src_operators__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/operators */ "./src/operators.ts");
...
class GameService {
    constructor(scheduler, sessionService) {
        ...
        this.allGames.pipe(Object(src_operators__WEBPACK_IMPORTED_MODULE_2__["tapLog"])('allGames')).subscribe();
    }
    ngOnDestroy() {
        this.destroyed.next(true);
        this.destroyed.complete();
...
/* harmony import */ var src_operators__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/operators */ "./src/operators.ts");
...
class SessionService {
    ...
    getEvents(message) {
        ...
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_0__["fromEvent"])(socket, message).pipe(Object(src_operators__WEBPACK_IMPORTED_MODULE_3__["tapLog"])('event', message), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["observeOn"])(scheduler));
    }
    emit(message, data = {}) {
...
/*!**************************!*\
  !*** ./src/operators.ts ***!
  \**************************/
/*! exports provided: tapLog */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "tapLog", function() { return tapLog; });
/* harmony import */ var core_js_modules_web_dom_iterable__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/web.dom.iterable */ "./node_modules/core-js/modules/web.dom.iterable.js");
/* harmony import */ var core_js_modules_web_dom_iterable__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_iterable__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm5/operators/index.js");
...
const tapLog = (...prefixes) => Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["tap"])(['next', 'error', 'complete'].reduce((prev, key) => _objectSpread({}, prev, {
